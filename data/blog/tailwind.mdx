...
excerpt: 'Learn why I switched my Next.js blog to use Tailwind CSS and how it impacted performance.'
media: '/static/images/tailwind/banner.png'
...
<Image
  ...
  src={`/images/blog/tailwind/analytics.webp`}
  width={1000}
  height={782}
/>
